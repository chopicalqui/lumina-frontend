...
interface SelectProps extends LuminaControlOptions {
  sxFormControl?: SxProps;
  sxInputLabel?: SxProps;
  helperText?: string;
}

export type SelectOptions = SelectProps & MuiSelectProps;

const Select: React.FC<SelectOptions> = React.memo((props) => {
